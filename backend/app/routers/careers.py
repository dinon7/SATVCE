...
from app.models.career import CareerCreate, CareerUpdate, CareerResponse, CareerReportRequest, CareerReportResponse, CareerPreference, CareerPreferenceUpdate
...
@router.post("/careers/preferences/{career_title}")
...
@router.get("/careers/preferences")
